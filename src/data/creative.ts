 ...
 *
 * ⚠️ There is no ad imagery in this repo, and there should not be -- inventing
 * photographs for six brands that do not exist would be the one thing on this
 * screen that is pretending. Visual formats render a labelled placeholder
 * frame carrying the real ratio and duration; text and audio formats render
 * their ACTUAL content, because copy and a script are things this data can
 * honestly hold.
 */
